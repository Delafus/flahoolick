  ...
  return (
    <>
      ...
      <section className="page-hero page-px"
        ...
        <div className="max-container w-full flex flex-col gap-10">
          <Image src="/logo-sobre-flahoolick.svg" alt="Flahoolick" width={531} height={284}
            style={{ filter: 'brightness(0)', maxWidth: '420px', width: '100%', height: 'auto' }}
            priority />
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
            ...
            <div className="md:col-span-8 flex flex-col gap-8">
              <div>
                ...
                <h2 className="text-headline" style={{ color: 'var(--section-body-text)' }}>
                  Felipe de la Fuente
                </h2>
              ...
              <div className="flex flex-col gap-6">
                ...
                <p className="text-lead opacity-75">
                  Esa brecha se convirtió en su obsesión. Y en Flahoolick.
                </p>
              </div>
      ...
      {/* Más sobre Flahoolick — estilo NOBL More About Us */}
      <section
        className="page-px section-py"
        style={{ backgroundColor: 'var(--section-dark-bg)', color: 'var(--section-dark-text)' }}
      >
        <div className="max-container flex flex-col gap-16">
          <h2 className="text-headline" style={{ color: 'var(--section-dark-text)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px" style={{ background: 'rgba(255,255,255,0.1)' }}>
            ...
            <div className="flex flex-col gap-8 p-10" style={{ backgroundColor: 'var(--section-dark-bg)' }}>
              <svg width="28" height="20" viewBox="0 0 28 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0" y="0" width="8" height="8" fill="#F09DB6"/>
                <rect x="10" y="0" width="8" height="8" fill="#F09DB6" opacity="0.5"/>
                <rect x="20" y="0" width="8" height="8" fill="#F09DB6" opacity="0.25"/>
                <rect x="0" y="12" width="8" height="8" fill="#F09DB6" opacity="0.5"/>
                <rect x="10" y="12" width="8" height="8" fill="#F09DB6"/>
                <rect x="20" y="12" width="8" height="8" fill="#F09DB6" opacity="0.5"/>
              </svg>
              <div className="flex flex-col gap-4 flex-1">
                <p className="label font-bold">CAPACIDADES</p>
                <p className="text-sm leading-relaxed opacity-60">
                  Los tres frentes de nuestro trabajo — los contextos en los que operan nuestros clientes y las razones más frecuentes por las que una empresa B2B nos llama. Explora cómo podemos acompañarte.
                </p>
              </div>
              <Link href="/capacidades"
                className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium hover:opacity-60 transition-opacity w-fit"
            ...
            <div className="flex flex-col gap-8 p-10" style={{ backgroundColor: 'var(--section-dark-bg)' }}>
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="10" y="0" width="8" height="8" fill="#F5FD92"/>
                <rect x="0" y="10" width="8" height="8" fill="#F5FD92" opacity="0.5"/>
                <rect x="10" y="10" width="8" height="8" fill="#F5FD92"/>
                <rect x="20" y="10" width="8" height="8" fill="#F5FD92" opacity="0.5"/>
                <rect x="5" y="20" width="8" height="8" fill="#F5FD92" opacity="0.35"/>
                <rect x="15" y="20" width="8" height="8" fill="#F5FD92" opacity="0.35"/>
              </svg>
              <div className="flex flex-col gap-4 flex-1">
                <p className="label font-bold">METODOLOGÍA</p>
                <p className="text-sm leading-relaxed opacity-60">
                  El cómo y el qué de nuestro trabajo — el sistema diseñado para ciclos de decisión complejos y refinado durante cientos de proyectos. Descubre cómo funciona el sistema.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-8 p-10" style={{ backgroundColor: 'var(--section-dark-bg)' }}>
              <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0" y="0" width="18" height="4" fill="#F9F0E2"/>
                <rect x="0" y="8" width="28" height="4" fill="#F9F0E2" opacity="0.5"/>
                <rect x="0" y="16" width="12" height="4" fill="#F9F0E2" opacity="0.75"/>
              </svg>
              <div className="flex flex-col gap-4 flex-1">
                <p className="label font-bold">JERGA</p>
                <p className="text-sm leading-relaxed opacity-60">
                  Lo aprendido en el trabajo — estrategia de contenido, marketing B2B y autoridad de mercado. Ideas y herramientas para líderes que necesitan que el mercado los recuerde cuando decida comprar.
                </p>
              </div>
              <Link href="/jerga"
                className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium hover:opacity-60 transition-opacity w-fit"
